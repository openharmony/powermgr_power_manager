...
enum class UserActivityType : uint32_t {
    ...
    USER_ACTIVITY_TYPE_APPLICATION = 8,
    USER_ACTIVITY_TYPE_MAX = USER_ACTIVITY_TYPE_APPLICATION,
};
...
enum class InterfaceTimeoutType : uint32_t {
    ...
    INTERFACE_TIMEOUT_TYPE_ULSR_SYNC_CALLBACK = 4,
...
enum class StateChangeReason : uint32_t {
    ...
    STATE_CHANGE_REASON_TENT_MODE = 49,
    STATE_CHANGE_REASON_START_DREAM = 50,
    STATE_CHANGE_REASON_END_DREAM = 51,
    STATE_CHANGE_REASON_BLUETOOTH_INCOMING_CALL = 52,
    STATE_CHANGE_REASON_WAKEUP_FROM_ULSR = 53,
    STATE_CHANGE_REASON_MESSAGE_NOTIFICATION = 54,
    STATE_CHANGE_REASON_WIRED_APPCAST = 55,
    ...
    STATE_CHANGE_REASON_SWITCH_SENSORHUB = 105,
    STATE_CHANGE_REASON_PLUG_CHANGE = 106,
    STATE_CHANGE_REASON_PEOPLE_LEAVING = 107,
