...
enum class WakeupDeviceType : uint32_t {
    ...
    WAKEUP_DEVICE_PRE_BRIGHT_ATUH_SUCCESS = 19,
    WAKEUP_DEVICE_PRE_BRIGHT_ATUH_FAIL_SCREEN_ON = 20,
    WAKEUP_DEVICE_PRE_BRIGHT_ATUH_FAIL_SCREEN_OFF = 21,
    WAKEUP_DEVICE_MAX = WAKEUP_DEVICE_SINGLE_CLICK,
};
...
enum class SuspendDeviceType : uint32_t {
    ...
    SUSPEND_DEVICE_REASON_MAX = SUSPEND_DEVICE_LOW_CAPACITY,
#else
    SUSPEND_DEVICE_REASON_MAX = SUSPEND_DEVICE_REASON_SWITCH,
#endif
};
