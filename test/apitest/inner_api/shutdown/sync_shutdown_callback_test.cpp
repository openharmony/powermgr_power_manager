...
{
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallbackk001 start");
    ...
    EXPECT_TRUE(g_isDefaultPriority);
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallback001 end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallbackk002 start");
    ...
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallbackk002 end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallbackk003 start");
    auto lowPriorityCallback = new LowPrioritySyncShutdownCallback();
    g_service->RegisterShutdownCallback(lowPriorityCallback, ShutdownPriority::LOW);
    ...
    EXPECT_TRUE(g_isLowPriority);
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallbackk003 end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallback004 start");
    auto defaultPriorityCallback = new SyncShutdownCallback();
    g_service->RegisterShutdownCallback(defaultPriorityCallback, ShutdownPriority::DEFAULT);
    auto highPriorityCallback = new HighPrioritySyncShutdownCallback();
    g_service->RegisterShutdownCallback(highPriorityCallback, ShutdownPriority::HIGH);
    ...
    EXPECT_TRUE(g_isHighPriority);
    EXPECT_TRUE(g_isDefaultPriority);
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallback004 end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallback005 start");
    ...
    g_service->ShutDownDevice("test_shutdown");
    POWER_HILOGD(LABEL_TEST, "SyncShutdownCallback005 end");
}
} // namespace UnitTest
} // namespace PowerMgr
} // namespace OHOS
