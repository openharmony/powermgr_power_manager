...
class SUB_SCREEN_STATE_WITHOUT_AOD_TEST(TestCase):
    ...
    def setup(self):
        self.log.info("SUB_SCREEN_STATE_WITHOUT_AOD_TEST start")
        #处理可能会弹出的USB连接方式弹窗
    ...
    def teardown(self):
        Step("收尾工作")
        self.log.info("SUB_SCREEN_STATE_WITHOUT_AOD_TEST down")
