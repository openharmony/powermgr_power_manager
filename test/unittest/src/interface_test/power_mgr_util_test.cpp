...
{
    POWER_HILOGI(LABEL_TEST, "PermissionIsSystemNative function start!");
    ...
    EXPECT_TRUE(Permission::IsSystem());
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGI(LABEL_TEST, "PermissionIsSystemNative function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "PermissionIsSystemHap function start!");
    ...
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGI(LABEL_TEST, "PermissionIsSystemHap function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "PermissionIsSystemInvalid function start!");
    ...
    EXPECT_FALSE(Permission::IsSystem());
    EXPECT_FALSE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGI(LABEL_TEST, "PermissionIsSystemInvalid function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "PermissionIsPermissionGrantedHap function start!");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_HAP);
    ...
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGI(LABEL_TEST, "PermissionIsPermissionGrantedHap function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "PermissionIsPermissionGrantedNative function start!");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));

    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_SHELL);
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGI(LABEL_TEST, "PermissionIsPermissionGrantedNative function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "PermissionIsPermissionGrantedInvalid function start!");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_INVALID);
    EXPECT_FALSE(Permission::IsPermissionGranted("REBOOT"));
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_TYPE_BUTT);
    EXPECT_FALSE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGI(LABEL_TEST, "PermissionIsPermissionGrantedInvalid function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "IsNativePermissionGrantedHap function start!");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_HAP);
    MockAccesstokenKit::MockSetSystemApp(false);
    EXPECT_FALSE(Permission::IsSystem());
    ...
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    EXPECT_TRUE(Permission::IsNativePermissionGranted("POWER_OPTIMIZATION"));
    POWER_HILOGI(LABEL_TEST, "IsNativePermissionGrantedHap function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "IsNativePermissionGrantedNative function start!");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_DENIED);
    ...
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    EXPECT_TRUE(Permission::IsNativePermissionGranted("POWER_OPTIMIZATION"));
    POWER_HILOGI(LABEL_TEST, "IsNativePermissionGrantedNative function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "IsNativePermissionGrantedInvalid function start!");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_INVALID);
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_DENIED);
    EXPECT_FALSE(Permission::IsNativePermissionGranted("POWER_OPTIMIZATION"));
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    ...
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    EXPECT_FALSE(Permission::IsNativePermissionGranted("POWER_OPTIMIZATION"));
    POWER_HILOGI(LABEL_TEST, "IsNativePermissionGrantedInvalid function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "SettingObserver001 function start!");
    ...
    POWER_HILOGI(LABEL_TEST, "SettingObserver001 function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "SettingProvider001 function start!");
    ...
    POWER_HILOGI(LABEL_TEST, "SettingProvider001 function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "SettingProvider002 function start!");
    auto& settingProvider = SettingProvider::GetInstance(OHOS::POWER_MANAGER_SERVICE_ID);
    int32_t putValue = 10;
    int32_t getValue;
...
{
    POWER_HILOGI(LABEL_TEST, "SettingProvider003 function start!");
    auto& settingProvider = SettingProvider::GetInstance(OHOS::POWER_MANAGER_SERVICE_ID);
    int64_t value;
...
{
    POWER_HILOGI(LABEL_TEST, "SettingProvider004 function start!");
    ...
    EXPECT_EQ(OHOS::ERR_OK, ret);
    POWER_HILOGI(LABEL_TEST, "SettingProvider004 function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "SettingProvider005 function start!");
    auto& settingProvider = SettingProvider::GetInstance(OHOS::POWER_MANAGER_SERVICE_ID);
    settingProvider.UpdateCurrentUserId();
    EXPECT_NE(settingProvider.currentUserId_, INVALID_CODE);
    POWER_HILOGI(LABEL_TEST, "SettingProvider005 function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "SettingProvider006 function start!");
    auto& settingProvider = SettingProvider::GetInstance(OHOS::POWER_MANAGER_SERVICE_ID);
    ...
    POWER_HILOGI(LABEL_TEST, "SettingProvider006 function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "Sysparam001 function start!");
    ...
    POWER_HILOGI(LABEL_TEST, "Sysparam001 function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "PowerVibratorTest001 function start!");
    ...
    POWER_HILOGI(LABEL_TEST, "PowerVibratorTest001 function end!");
}
...
{
    POWER_HILOGI(LABEL_TEST, "PowerVibratorTest002 function start!");
    std::shared_ptr<PowerVibrator> vibrator = PowerVibrator::GetInstance();
    EXPECT_TRUE(vibrator != nullptr);
    ...
    vibrator->StartVibrator(SHUTDOWN_DIAG);
    POWER_HILOGI(LABEL_TEST, "PowerVibratorTest002 function end!");
}
} // namespace
