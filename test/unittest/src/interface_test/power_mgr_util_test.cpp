...
{
    POWER_HILOGD(LABEL_TEST, "PermissionIsSystemNative start");
    ...
    EXPECT_TRUE(Permission::IsSystem());
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGD(LABEL_TEST, "PermissionIsSystemNative end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PermissionIsSystemHap start");
    ...
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGD(LABEL_TEST, "PermissionIsSystemHap end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PermissionIsSystemInvalid start");
    ...
    EXPECT_FALSE(Permission::IsSystem());
    EXPECT_FALSE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGD(LABEL_TEST, "PermissionIsSystemInvalid end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PermissionIsPermissionGrantedHap start");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_HAP);
    ...
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGD(LABEL_TEST, "PermissionIsPermissionGrantedHap end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PermissionIsPermissionGrantedNative start");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));

    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_SHELL);
    EXPECT_TRUE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGD(LABEL_TEST, "PermissionIsPermissionGrantedNative end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PermissionIsPermissionGrantedInvalid start");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_INVALID);
    EXPECT_FALSE(Permission::IsPermissionGranted("REBOOT"));
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_TYPE_BUTT);
    EXPECT_FALSE(Permission::IsPermissionGranted("REBOOT"));
    POWER_HILOGD(LABEL_TEST, "PermissionIsPermissionGrantedInvalid end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "IsNativePermissionGrantedHap start");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_HAP);
    MockAccesstokenKit::MockSetSystemApp(false);
    EXPECT_FALSE(Permission::IsSystem());
    ...
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    EXPECT_TRUE(Permission::IsNativePermissionGranted("POWER_OPTIMIZATION"));
    POWER_HILOGD(LABEL_TEST, "IsNativePermissionGrantedHap end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "IsNativePermissionGrantedNative start");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_NATIVE);
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_DENIED);
    ...
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    EXPECT_TRUE(Permission::IsNativePermissionGranted("POWER_OPTIMIZATION"));
    POWER_HILOGD(LABEL_TEST, "IsNativePermissionGrantedNative end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "IsNativePermissionGrantedInvalid start");
    MockAccesstokenKit::MockSetTokenTypeFlag(ATokenTypeEnum::TOKEN_INVALID);
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_DENIED);
    EXPECT_FALSE(Permission::IsNativePermissionGranted("POWER_OPTIMIZATION"));
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    ...
    MockAccesstokenKit::MockSetPermissionState(PermissionState::PERMISSION_GRANTED);
    EXPECT_FALSE(Permission::IsNativePermissionGranted("POWER_OPTIMIZATION"));
    POWER_HILOGD(LABEL_TEST, "IsNativePermissionGrantedInvalid end");
}
...
{
    POWER_HILOGD(LABEL_TEST, "SettingProvider005::fun is start!");
    auto& settingProvider = SettingProvider::GetInstance(OHOS::POWER_MANAGER_SERVICE_ID);
...
{
    POWER_HILOGD(LABEL_TEST, "PowerVibratorTest001 is start!");
    ...
    POWER_HILOGD(LABEL_TEST, "PowerVibratorTest001 is end!");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerVibratorTest002 is start!");
    std::shared_ptr<PowerVibrator> vibrator = PowerVibrator::GetInstance();
    EXPECT_TRUE(vibrator != nullptr);
    ...
    vibrator->StartVibrator(SHUTDOWN_DIAG);
    POWER_HILOGD(LABEL_TEST, "PowerVibratorTest002 is end!");
}
} // namespace
