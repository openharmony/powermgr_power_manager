...
/**
 * @tc.name: PowerWakeupControllerTest025
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest025, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest025 function start!");
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    EXPECT_TRUE(wakeupController_ != nullptr);
    ...
    callbackThird->OnInputEvent(axisEvent);
    delete callbackThird;
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest025 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest026
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest026, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest026 function start!");
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    EXPECT_TRUE(wakeupController_ != nullptr);
    ...
    callbackThird->OnInputEvent(axisEvent);
    delete callbackThird;
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest026 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest027
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest027, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest027 function start!");
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    EXPECT_TRUE(wakeupController_ != nullptr);
    ...
    callbackThird->OnInputEvent(axisEvent);
    delete callbackThird;
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest027 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest028
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest028, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest028 function start!");
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    EXPECT_TRUE(wakeupController_ != nullptr);
    ...
    callbackThird->OnInputEvent(axisEvent);
    delete callbackThird;
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest028 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest029
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest029, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest029 function start!");
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    EXPECT_TRUE(wakeupController_ != nullptr);
    ...
    callbackThird->OnInputEvent(axisEvent);
    delete callbackThird;
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest029 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest030
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest030, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest030 function start!");
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    EXPECT_TRUE(wakeupController_ != nullptr);
    ...
    callbackThird->OnInputEvent(axisEvent);
    delete callbackThird;
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest030 function end!");
}
#endif


/**
 * @tc.name: PowerWakeupControllerTest031
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest031, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest031 function start!");
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    EXPECT_TRUE(wakeupController_ != nullptr);
    ...
    callbackThird->OnInputEvent(axisEvent);
    delete callbackThird;
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest031 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest032
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest032, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest032 function start!");
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    EXPECT_TRUE(wakeupController_ != nullptr);
    ...
    callbackThird->OnInputEvent(axisEvent);
    delete callbackThird;
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest032 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest033
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest033, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest033 function start!");
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest033: start";
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    ...
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest033: end";
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest033 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest034
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest034, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest034 function start!");
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest034: start";
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    g_service->SwitchSubscriberInit();
    ...
    g_service->InputMonitorCancel();
    g_service->SwitchSubscriberCancel();
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest034: end";
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest034 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest035
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest035, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest035 function start!");
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest035: start";
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    g_service->SwitchSubscriberInit();
    ...
    g_service->InputMonitorCancel();
    g_service->SwitchSubscriberCancel();
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest035: end";
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest035 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest036
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest036, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest036 function start!");
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest036: start";
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    g_service->SwitchSubscriberInit();
    ...
    g_service->InputMonitorCancel();
    g_service->SwitchSubscriberCancel();
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest036: end";
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest036 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest037
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest037, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest037 function start!");
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest037: start";
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    g_service->SwitchSubscriberInit();
    ...
    g_service->InputMonitorCancel();
    g_service->SwitchSubscriberCancel();
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest037: end";
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest037 function end!");
}
#endif

/**
 * @tc.name: PowerWakeupControllerTest038
 * @tc.desc: test RegisterMonitor(Normal)
 * @tc.type: FUNC
 * @tc.require: issueI7COGR
 */
#ifdef HAS_MULTIMODALINPUT_INPUT_PART
HWTEST_F(PowerWakeupControllerTest, PowerWakeupControllerTest038, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest038 function start!");
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest038: start";
    auto powerStateMachine = g_service->GetPowerStateMachine();
    g_service->WakeupControllerInit();
    auto wakeupController_ = g_service->GetWakeupController();
    g_service->SwitchSubscriberInit();
    ...
    g_service->InputMonitorCancel();
    g_service->SwitchSubscriberCancel();
    GTEST_LOG_(INFO) << "PowerWakeupControllerTest038: end";
    POWER_HILOGI(LABEL_TEST, "PowerWakeupControllerTest038 function end!");
}
#endif
