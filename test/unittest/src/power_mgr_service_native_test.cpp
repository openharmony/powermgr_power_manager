...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative001 begin.");
    ...
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative001 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative002 begin.");
    int32_t keyCode = OHOS::MMI::KeyEvent::KEYCODE_F1;
    g_pmsTest->HandleKeyEvent(keyCode);
    ...
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative002 end.");
}
...
HWTEST_F(PowerMgrServiceNativeTest, PowerMgrServiceNative003, TestSize.Level0)
{
    ...
    EXPECT_TRUE(SettingHelper::pickUpObserver_ == nullptr);
#endif
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative003 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative004 begin.");
    ...
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative004 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative005 begin.");
    shared_ptr<PowerModeModule> powerModeModuleTest = make_shared<PowerModeModule>();
    EXPECT_TRUE(powerModeModuleTest != nullptr);
    powerModeModuleTest->RegisterAutoAdjustBrightnessObserver();
    ...
    auto ret = SettingHelper::GetSettingAutoAdjustBrightness(INVALID_CODE);
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative005 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative006 begin.");
    shared_ptr<PowerModeModule> powerModeModuleTest = make_shared<PowerModeModule>();
    EXPECT_TRUE(powerModeModuleTest != nullptr);
    ...
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative006 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative007 begin.");
    shared_ptr<PowerModeModule> powerModeModuleTest = make_shared<PowerModeModule>();
    EXPECT_TRUE(powerModeModuleTest != nullptr);
    ...
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative007 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative008 begin.");
    shared_ptr<PowerModeModule> powerModeModuleTest = make_shared<PowerModeModule>();
    EXPECT_TRUE(powerModeModuleTest != nullptr);
    ...
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative008 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative009 begin.");
    ...
    EXPECT_TRUE(SettingHelper::powerModeObserver_ == nullptr);
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative009 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative010 begin.");
    ...
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative010 end.");
}
...
#endif
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative011 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative012 begin.");
...
#endif
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative012 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative013 begin.");
    ...
    EXPECT_TRUE(g_pmsTest->externalScreenListener_ == nullptr);
#endif
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative013 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative014 begin.");
#ifdef POWER_MANAGER_ENABLE_EXTERNAL_SCREEN_MANAGEMENT
    ...
    EXPECT_TRUE(g_pmsTest->externalScreenListener_ == nullptr);
#endif
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative014 end.");
}
...
{
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative015 begin.");
#ifdef POWER_MANAGER_ENABLE_EXTERNAL_SCREEN_MANAGEMENT
    g_pmsTest->SuspendControllerInit();
    g_pmsTest->WakeupControllerInit();
    // Register screen listener
    ...
    EXPECT_TRUE(g_pmsTest->externalScreenListener_ == nullptr);
#endif
    POWER_HILOGD(LABEL_TEST, "PowerMgrServiceNative015 end.");
}
