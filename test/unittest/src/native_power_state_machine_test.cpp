...
HWTEST_F(NativePowerStateMachineTest, NativePowerStateMachine013, TestSize.Level0)
{
    ...
    data.status = 1;
    pmsTest->HallSensorCallback(&event);
    EXPECT_TRUE(PowerMgrService::isInLidMode_);
...
/**
 * @tc.name: NativePowerStateMachine014
 * @tc.desc: test Lid Fold
 * @tc.type: FUNC
 */
#ifdef HAS_SENSORS_SENSOR_PART
#ifdef POWER_LID_FOLD_ENABLE
HWTEST_F(NativePowerStateMachineTest, NativePowerStateMachine014, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "NativePowerStateMachine014 function start!");
    auto pmsTest = DelayedSpSingleton<PowerMgrService>::GetInstance();
    pmsTest->OnStart();
    pmsTest->SuspendControllerInit();
    pmsTest->WakeupControllerInit();
    ...
    pmsTest->HallSensorCallback(&event);
    EXPECT_FALSE(PowerMgrService::isInLidMode_);
    POWER_HILOGI(LABEL_TEST, "NativePowerStateMachine014 function end!");
}
#endif
#endif

/**
 * @tc.name: NativePowerStateMachine015
 * @tc.desc: test Lid Fold
 * @tc.type: FUNC
 */
#ifdef HAS_SENSORS_SENSOR_PART
#ifdef POWER_LID_FOLD_ENABLE
HWTEST_F(NativePowerStateMachineTest, NativePowerStateMachine015, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "NativePowerStateMachine015 function start!");
    auto pmsTest = DelayedSpSingleton<PowerMgrService>::GetInstance();
    pmsTest->OnStart();
    pmsTest->SuspendControllerInit();
    pmsTest->WakeupControllerInit();
    ...
    pmsTest->HallSensorCallback(&event);
    EXPECT_TRUE(PowerMgrService::isInLidMode_);
    POWER_HILOGI(LABEL_TEST, "NativePowerStateMachine015 function end!");
}
#endif
#endif

/**
 * @tc.name: NativePowerStateMachine016
 * @tc.desc: test Lid Fold
 * @tc.type: FUNC
 */
#ifdef HAS_SENSORS_SENSOR_PART
#ifdef POWER_LID_FOLD_ENABLE
HWTEST_F(NativePowerStateMachineTest, NativePowerStateMachine016, TestSize.Level0)
{
    POWER_HILOGI(LABEL_TEST, "NativePowerStateMachine016 function start!");
    auto pmsTest = DelayedSpSingleton<PowerMgrService>::GetInstance();
    pmsTest->OnStart();
    pmsTest->SuspendControllerInit();
    pmsTest->WakeupControllerInit();
    ...
    pmsTest->HallSensorCallback(&event);
    EXPECT_TRUE(PowerMgrService::isInLidMode_);
    POWER_HILOGI(LABEL_TEST, "NativePowerStateMachine016 function end!");
}
#endif
#endif
...
HWTEST_F(NativePowerStateMachineTest, NativePowerStateMachine019, TestSize.Level1)
{
    ...
    int64_t restoredTime = stateMachine->GetDisplayOffTime();
    EXPECT_NE(restoredTime, OVERRIDE_TIME);
 ...
 * @tc.desc: test DisplayOffTimeUpdateFunc returns early when settingTime equals systemTime
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: test DisplayOffTimeUpdateFunc updates displayOffTime when settingTime differs from systemTime
 * @tc.type: FUNC
 */
HWTEST_F(NativePowerStateMachineTest, NativePowerStateMachine021, TestSize.Level1)
{
    ...
    constexpr int64_t ARTIFICIAL_TIME = 9999;
    stateMachine->SetDisplayOffTime(ARTIFICIAL_TIME, false);
    EXPECT_EQ(stateMachine->GetDisplayOffTime(), ARTIFICIAL_TIME);

    PowerStateMachine::DisplayOffTimeUpdateFunc();
    EXPECT_FALSE(stateMachine->isScreenOffTimeOverride_);

    EXPECT_NE(stateMachine->GetDisplayOffTime(), ARTIFICIAL_TIME);
 ...
 * @tc.desc: test Restore recovers to latest Setting value after AC/DC switch during override
 * @tc.type: FUNC
 */
HWTEST_F(NativePowerStateMachineTest, NativePowerStateMachine022, TestSize.Level1)
{
    ...
    constexpr int64_t BASE_TIME = 30000;
    constexpr int64_t OVERRIDE_TIME = 600000;
    stateMachine->SetDisplayOffTime(BASE_TIME, false);
    EXPECT_EQ(stateMachine->GetDisplayOffTime(), BASE_TIME);
