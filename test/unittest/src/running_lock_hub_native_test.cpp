...
{
    GTEST_LOG_(INFO) << "RunningLockNative001 start";
    ...
    GTEST_LOG_(INFO) << "RunningLockNative001 end";
}
...
{
    GTEST_LOG_(INFO) << "RunningLockNative002 start";
    ...
    GTEST_LOG_(INFO) << "RunningLockNative002 end";
}
} // namespace