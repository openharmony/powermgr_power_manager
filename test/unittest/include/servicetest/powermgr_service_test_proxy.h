...
public:
    ...
    int32_t RegisterUlsrCallbackIpc(const sptr<IUlsrCallback>& callback, int32_t& powerError);
    int32_t UnRegisterUlsrCallbackIpc(const sptr<IUlsrCallback>& callback, int32_t& powerError);
private:
