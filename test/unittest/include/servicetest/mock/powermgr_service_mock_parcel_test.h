...
#ifndef POWERMGR_SERVICE_MOCK_PARCEL_TEST_H
#define POWERMGR_SERVICE_MOCK_PARCEL_TEST_H
...
namespace OHOS {
namespace PowerMgr {
class PowerMgrServiceMockParcelTest : public testing::Test {
public:
...
#endif // POWERMGR_SERVICE_MOCK_PARCEL_TEST_H
